    ...
    return (
        <div className="pagination">
            <div className="pagination__container">
                <a className={coutPage > 1 ? "previous_page active" : "previous_page disabled"}
                    href="/"
                    onClick={onDectimentPage}>Previous</a>
                ...
                <a className={coutPage < allPage - 1 ? "next_page active" : "next_page disabled"}
                    href="/"
                    onClick={onIncrementPage}>Next</a>
            </div>
        </div>
    )
}
